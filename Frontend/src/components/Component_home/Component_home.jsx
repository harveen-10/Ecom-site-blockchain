...
function Component_home(props) {
    ...
    return <>
        <div className='my-8 border border-black shadow-xl rounded-xl w-1/4 h-auto mx-auto hover:bg-[#F9F9F9]'>
            <div className='py-8'>
                <div className='flex flex-col justify-center items-center'>
                    <img src={props.imgSrc} className='py-2 px-12 h-80' />
                    <h1 className='font-raleway font-black text-xl my-4'>{props.name}</h1>
                </div>
                <div className='flex justify-center items-center'>
                    <p className='mx-12 text-xl font-bold'>₹{props.price}</p>
                    <div className='mx-12 flex flex-row items-center border border-black bg-white text-black shadow rounded'>
